...
export interface ApiKategorijaKategorija extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    kategorijas: Schema.Attribute.Relation<'oneToMany', 'api::ponudba.ponudba'>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Zaporedje: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPonudbaPonudba extends Struct.CollectionTypeSchema {
  collectionName: 'ponudbas';
  info: {
    description: '';
    displayName: 'Ponudba';
    pluralName: 'ponudbas';
    singularName: 'ponudba';
  };
  options: {
    draftAndPublish: true;
  };
